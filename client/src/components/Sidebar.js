    ...
    return (
        <div className="fixed left-0 w-64 h-full bg-gray-900 text-white">
            <div>
                ...
                <div className="text-2xl pb-2 pt-3 ml-1">Categories</div>
                ...
                <button 
                    className="text-2xl pt-6 ml-1 mt-3 hover:text-orange-300" 
                    onClick={() => window.scrollTo({top: 0, behavior: "smooth"})}
                >
                    Back to top
                </button>
                <Link to="/new_article" className="flex flex-col text-2xl ml-1 mt-4 hover:text-orange-300">Create New Article</Link>
            </div>
        </div>
    )
};
